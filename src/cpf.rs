...
/// A valid CPF number. Parsing recognizes numbers with or without separators (dot, minus, slash,
/// and space).
...
impl Cpf {
    ...
    /// Generates a random CPF number, using [`rand::thread_rng`][rand] (optional dependency
    /// enabled by default). To use a different generator, instantiate the generator directly.
    ///
